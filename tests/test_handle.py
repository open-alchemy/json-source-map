...
from json_source_map.handle import array, object_, primitive, value
...
def test_value(source, location, expected_entries, expected_location):
    """
    GIVEN source, location and expected entries and location
    WHEN value is called with the source and location
    THEN the expected entries are returned and the location is at the expected location.
    """
    returned_entries = value(source=source, current_location=location)
...
def test_value_error(source, location):
    """
    ...
    with pytest.raises(InvalidJsonError):
        value(source=source, current_location=location)
...
def test_object_(source, location, expected_entries, expected_location):
    """
    GIVEN source, location and expected entries and location
    WHEN object_ is called with the source and location
    THEN the expected entries are returned and the location is at the expected location.
    """
    returned_entries = object_(source=source, current_location=location)
...
def test_object__error(source, location):
    """
    GIVEN source and location
    WHEN object_ is called with the source and location
    THEN InvalidJsonError is raised.
    """
    with pytest.raises(InvalidJsonError):
        object_(source=source, current_location=location)
...
def test_array(source, location, expected_entries, expected_location):
    """
    GIVEN source, location and expected entries and location
    WHEN array is called with the source and location
    THEN the expected entries are returned and the location is at the expected location.
    """
    returned_entries = array(source=source, current_location=location)
...
def test_array_error(source, location):
    """
    GIVEN source and location
    WHEN array is called with the source and location
    THEN InvalidJsonError is raised.
    """
    with pytest.raises(InvalidJsonError):
        array(source=source, current_location=location)
...
def test_primitive(source, location, expected_entries, expected_location):
    """
    GIVEN source, location and expected entries and location
    WHEN primitive is called with the source and location
    THEN the expected entries are returned and the location is at the expected location.
    """
    returned_entries = primitive(source=source, current_location=location)
...
def test_primitive_error(source, location):
    ...
    """
    with pytest.raises(InvalidJsonError):
        primitive(source=source, current_location=location)
